...
function initdb() {
  ...
  db.hmset("client:999999", "email", "tgrant@thomasgrant.co.uk", "password", "tgrant", "brokerid", "TGRANT", "clientid", 999999, "name", "Thomas Grant & Company", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999999, "commpercent", 0);
  db.set("client:tgrant@thomasgrant.co.uk", 999999);
  db.sadd("clients", 999998);
  db.hmset("client:999998", "email", "unknown@thomasgrant.co.uk", "password", "unknown", "brokerid", "UNKNOWN", "clientid", 999998, "name", "Unknown Counterparty", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999998, "commpercent", 0);
  db.set("client:unknown@thomasgrant.co.uk", 999998);
  db.sadd("clients", 999997);
  db.hmset("client:999997", "email", "winn@thomasgrant.co.uk", "password", "winn", "brokerid", "WNTSGB2LBIC", "clientid", 999997, "name", "Winterfloods", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999997, "commpercent", 0);
  db.set("client:winn@thomasgrant.co.uk", 999997);
  db.sadd("clients", 999996);
  db.hmset("client:999996", "email", "bmo@thomasgrant.co.uk", "password", "bmo", "brokerid", "NETHGB21", "clientid", 999996, "name", "BMO Capital Markets", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999996, "commpercent", 0);
  db.set("client:bmo@thomasgrant.co.uk", 999996);
  db.sadd("clients", 999995);
  db.hmset("client:999995", "email", "canaccord@thomasgrant.co.uk", "password", "canaccord", "brokerid", "CSTEGB21", "clientid", 999995, "name", "Canaccord", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999995, "commpercent", 0);
  db.set("client:canaccord@thomasgrant.co.uk", 999995);
  db.sadd("clients", 999994);
  db.hmset("client:999994", "email", "cantor@thomasgrant.co.uk", "password", "cantor", "brokerid", "CFEQGB21EPE", "clientid", 999994, "name", "Cantor Fitzgerald Europe", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999994, "commpercent", 0);
  db.set("client:cantor@thomasgrant.co.uk", 999994);
  db.sadd("clients", 999993);
  db.hmset("client:999993", "email", "cenkos@thomasgrant.co.uk", "password", "cenkos", "brokerid", "CNKOGB21", "clientid", 999993, "name", "Cenkos", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999993, "commpercent", 0);
  db.set("client:cenkos@thomasgrant.co.uk", 999993);
  db.sadd("clients", 999992);
  db.hmset("client:999992", "email", "espirito@thomasgrant.co.uk", "password", "espirito", "brokerid", "EXEUGBMM", "clientid", 999992, "name", "Espirito Di Santo", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999992, "commpercent", 0);
  db.set("client:espirito@thomasgrant.co.uk", 999992);
  db.sadd("clients", 999991);
  db.hmset("client:999991", "email", "finncap@thomasgrant.co.uk", "password", "finncap", "brokerid", "FCAPMM21", "clientid", 999991, "name", "Finncap", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999991, "commpercent", 0);
  db.set("client:finncap@thomasgrant.co.uk", 999991);
  db.sadd("clients", 999990);
  db.hmset("client:999990", "email", "fox@thomasgrant.co.uk", "password", "fox", "brokerid", "FOXD1234", "clientid", 999990, "name", "Fox Davies", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999990, "commpercent", 0);
  db.set("client:fox@thomasgrant.co.uk", 999990);
  db.sadd("clients", 999989);
  db.hmset("client:999989", "email", "davy@thomasgrant.co.uk", "password", "davy", "brokerid", "DAVEIE21", "clientid", 999989, "name", "Davy", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999989, "commpercent", 0);
  db.set("client:davy@thomasgrant.co.uk", 999989);
  db.sadd("clients", 999988);
  db.hmset("client:999988", "email", "gmp@thomasgrant.co.uk", "password", "gmp", "brokerid", "GMPSGB21", "clientid", 999988, "name", "GMP Securities", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999988, "commpercent", 0);
  db.set("client:gmp@thomasgrant.co.uk", 999988);
  db.sadd("clients", 999987);
  db.hmset("client:999987", "email", "jefferies@thomasgrant.co.uk", "password", "jefferies", "JEFFGB2X", "TGRANT", "clientid", 999987, "name", "Jefferies", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999987, "commpercent", 0);
  db.set("client:jefferies@thomasgrant.co.uk", 999987);
  db.sadd("clients", 999986);
  db.hmset("client:999986", "email", "jpmorgan@thomasgrant.co.uk", "password", "jpmorgan", "JPMSGB2L", "TGRANT", "clientid", 999986, "name", "JP Morgan Cazenove", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999986, "commpercent", 0);
  db.set("client:jpmorgan@thomasgrant.co.uk", 999986);
  db.sadd("clients", 999985);
  db.hmset("client:999985", "email", "investec@thomasgrant.co.uk", "password", "investec", "IHCSGB21002", "TGRANT", "clientid", 999985, "name", "Investec", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999985, "commpercent", 0);
  db.set("client:investec@thomasgrant.co.uk", 999985);
  db.sadd("clients", 999984);
  db.hmset("client:999984", "email", "knight@thomasgrant.co.uk", "password", "knight", "brokerid", "NITEGB21888", "clientid", 999984, "name", "Knight", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999984, "commpercent", 0);
  db.set("client:knight@thomasgrant.co.uk", 999984);
  db.sadd("clients", 999983);
  db.hmset("client:999983", "email", "rothschild@thomasgrant.co.uk", "password", "rothschild", "brokerid", "EDMRGB21", "clientid", 999983, "name", "LCF Rothschild", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999983, "commpercent", 0);
  db.set("client:rothschild@thomasgrant.co.uk", 999983);
  db.sadd("clients", 999982);
  db.hmset("client:999982", "email", "lloyds@thomasgrant.co.uk", "password", "lloyds", "brokerid", "LOYDGB22TSY", "clientid", 999982, "name", "Lloyds TSB", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999982, "commpercent", 0);
  db.set("client:lloyds@thomasgrant.co.uk", 999982);
  db.sadd("clients", 999981);
  db.hmset("client:999981", "email", "peelhunt@thomasgrant.co.uk", "password", "peelhunt", "brokerid", "PLHCGB2LBIC", "clientid", 999981, "name", "Peel Hunt", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999981, "commpercent", 0);
  db.set("client:peelhunt@thomasgrant.co.uk", 999981);
  db.sadd("clients", 999980);
  db.hmset("client:999980", "email", "liberum@thomasgrant.co.uk", "password", "liberum", "brokerid", "LCAPGB21", "clientid", 999980, "name", "Liberum", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999980, "commpercent", 0);
  db.set("client:liberum@thomasgrant.co.uk", 999980);
  db.sadd("clients", 999979);
  db.hmset("client:999979", "email", "macquarie@thomasgrant.co.uk", "password", "macquarie", "brokerid", "MAPUGB21", "clientid", 999979, "name", "MacQuarie", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999979, "commpercent", 0);
  db.set("client:macquarie@thomasgrant.co.uk", 999979);
  db.sadd("clients", 999978);
  db.hmset("client:999978", "email", "nomura@thomasgrant.co.uk", "password", "nomura", "brokerid", "CODCGB21", "clientid", 999978, "name", "Nomura Code", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999978, "commpercent", 0);
  db.set("client:nomura@thomasgrant.co.uk", 999978);
  db.sadd("clients", 999977);
  db.hmset("client:999977", "email", "novum@thomasgrant.co.uk", "password", "novum", "brokerid", "NSMMGB21", "clientid", 999977, "name", "Novum", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999977, "commpercent", 0);
  db.set("client:novum@thomasgrant.co.uk", 999977);
  db.sadd("clients", 999976);
  db.hmset("client:999976", "email", "numis@thomasgrant.co.uk", "password", "numis", "brokerid", "RAZHGB2LBIC", "clientid", 999976, "name", "Numis", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999976, "commpercent", 0);
  db.set("client:numis@thomasgrant.co.uk", 999976);
  db.sadd("clients", 999975);
  db.hmset("client:999975", "email", "oriel@thomasgrant.co.uk", "password", "oriel", "brokerid", "ORSNGB21", "clientid", 999975, "name", "Oriel Securities", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999975, "commpercent", 0);
  db.set("client:oriel@thomasgrant.co.uk", 999975);
  db.sadd("clients", 999974);
  db.hmset("client:999974", "email", "panmure@thomasgrant.co.uk", "password", "panmure", "brokerid", "PMURGB2L", "clientid", 999974, "name", "Panmure", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999974, "commpercent", 0);
  db.set("client:panmure@thomasgrant.co.uk", 999974);
  db.sadd("clients", 999973);
  db.hmset("client:999973", "email", "rbc@thomasgrant.co.uk", "password", "rbc", "brokerid", "ROYCCG22", "clientid", 999973, "name", "RBC", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999973, "commpercent", 0);
  db.set("client:rbc@thomasgrant.co.uk", 999973);
  db.sadd("clients", 999972);
  db.hmset("client:999972", "email", "shore@thomasgrant.co.uk", "password", "shore", "brokerid", "SHOCGB2L", "clientid", 999972, "name", "Shore Capital", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999972, "commpercent", 0);
  db.set("client:shore@thomasgrant.co.uk", 999972);
  db.sadd("clients", 999971);
  db.hmset("client:999971", "email", "singer@thomasgrant.co.uk", "password", "singer", "brokerid", "SNGRGB21", "clientid", 999971, "name", "Singer Capital Markets", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999971, "commpercent", 0);
  db.set("client:singer@thomasgrant.co.uk", 999971);
  db.sadd("clients", 999970);
  db.hmset("client:999970", "email", "susquehanna@thomasgrant.co.uk", "password", "susquehanna", "brokerid", "SISSIE21", "clientid", 999970, "name", "Susquehanna International", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999970, "commpercent", 0);
  db.set("client:susquehanna@thomasgrant.co.uk", 999970);
  db.sadd("clients", 999969);
  db.hmset("client:999969", "email", "westhouse@thomasgrant.co.uk", "password", "westhouse", "brokerid", "WSMM1234", "clientid", 999969, "name", "Westhouse Securities", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999969, "commpercent", 0);
  db.set("client:westhouse@thomasgrant.co.uk", 999969);
  db.sadd("clients", 999968);
  db.hmset("client:999968", "email", "whireland@thomasgrant.co.uk", "password", "whireland", "brokerid", "WHISGBMM", "clientid", 999968, "name", "WH Ireland", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999968, "commpercent", 0);
  db.set("client:whireland@thomasgrant.co.uk", 999968);
  db.sadd("clients", 999967);
  db.hmset("client:999967", "email", "xcap@thomasgrant.co.uk", "password", "xcap", "brokerid", "CAPXGB21", "clientid", 999967, "name", "XCAP", "address", "", "mobile", "", "hedge", 0, "type", 2, "brokerclientcode", 999967, "commpercent", 0);
  db.set("client:xcap@thomasgrant.co.uk", 999967);
