...
static enum fix_type fix_tag_type(int tag)
{
	...
	case RptSeq:			return FIX_TYPE_INT;
        case NoRelatedSym:              return FIX_TYPE_INT;  
	...
	case Price:			return FIX_TYPE_FLOAT;
        case CashOrderQty:              return FIX_TYPE_FLOAT;
	...
	case OrdStatus:			return FIX_TYPE_CHAR;
	case ExecType:			return FIX_TYPE_CHAR;
	...
	case Side:			return FIX_TYPE_CHAR;
	case Text:			return FIX_TYPE_STRING;
        case QuoteReqID:                return FIX_TYPE_STRING; 
        case IDSource:                  return FIX_TYPE_STRING;
        case SecurityExchange:          return FIX_TYPE_STRING;
        case Currency:                  return FIX_TYPE_STRING;
        case SettlCurrency:             return FIX_TYPE_STRING;
        case FutSettDate:               return FIX_TYPE_STRING;
        case Qbroker:                   return FIX_TYPE_STRING;
	case OrdRejReason:		return FIX_TYPE_INT;
	case MultiLegReportingType:	return FIX_TYPE_CHAR;
        case SettlmntTyp:               return FIX_TYPE_CHAR; 
        case RefTagID:                  return FIX_TYPE_INT;
        case RefMsgType:                return FIX_TYPE_STRING;
        case SessionRejectReason:       return FIX_TYPE_INT;
        case QuoteRejectReason:         return FIX_TYPE_INT;
        case QuoteAckStatus:            return FIX_TYPE_INT;
        case QuoteID:                   return FIX_TYPE_STRING;
        case OnBehalfOfCompID:          return FIX_TYPE_STRING;
        case BidPx:                     return FIX_TYPE_FLOAT;
        case OfferPx:                   return FIX_TYPE_FLOAT;
        case BidSize:                   return FIX_TYPE_FLOAT;
        case OfferSize:                 return FIX_TYPE_FLOAT;
        case BidQuoteDepth:             return FIX_TYPE_INT;
        case OfferQuoteDepth:           return FIX_TYPE_INT;
        case BidSpotRate:               return FIX_TYPE_FLOAT;
        case OfferSpotRate:             return FIX_TYPE_FLOAT;
        case SettleDays:                return FIX_TYPE_INT; 
        case ValidUntilTime:            return FIX_TYPE_STRING; 
